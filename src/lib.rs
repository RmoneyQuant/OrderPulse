...
/// Loads the NSE FO/CM contract master CSV in Rust and provides fast token to symbol lookups.
///
/// Usage:
///
/// ```text
...
/// ```
///
/// When a symbol master is attached, streamed messages are enriched with
/// token_symbol, strike_price, option_type, expiry, lot_size, and name.
#[pyclass]
